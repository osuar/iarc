...
int main(void){
	...
	/*Joystick Axis buffer
	  [0] - Y axis tilt (motor 1 and 3) forward = negative
	  [1] - X axis tilt (motor 2 and 4) left = negative
	  [2] - Throttle  forward = negative 
	  [3] - Rotation about Z axis counter clockwise =negative
	 */
...
/*
				integration[0] += pry[0] - joystick[1];
				integration[1] += pry[1] - joystick[0]
*/
