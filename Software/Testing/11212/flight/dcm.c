...
void motorSpeed(int * pry,
	...
	motorSpeeds[0] += (-pry[1] * pidValues[0]/pidValuesDen[0]) + (integration[0] * pidValues[1]) + (gyroint[1] * pidValues[2]);
	motorSpeeds[2] -= (-pry[1] * pidValues[0]/pidValuesDen[0]) + (integration[0] * pidValues[1]) + (gyroint[1] * pidValues[2]);
	...
	motorSpeeds[1] += (-pry[0] * pidValues[0]/pidValuesDen[0]) + (integration[1] * pidValues[1]) + (gyroint[0] * pidValues[2]);
	motorSpeeds[3] -= (-pry[0] * pidValues[0]/pidValuesDen[0]) + (integration[1] * pidValues[1]) + (gyroint[0] * pidValues[2]);
