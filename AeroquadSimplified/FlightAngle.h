...
public:
  ...
  virtual void initialize(float hdgX, float hdgY);	//shouldnt be needed.
  ...
  virtual void calibrate();	//shouldnt be needed.
...
//THIS IS THE MOST IMPORTANT PART! THE PART WE NEED TO COPY!
...
// There was magnatometer code here, but its been deleted since were using the ARG code below.
